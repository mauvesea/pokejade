...
CherrygroveCity_MapEvents:
	...
	warp_event 29, 11, CHERRYGROVE_EVOLUTION_SPEECH_HOUSE, 1
	...
	bg_event 26,  9, BGEVENT_READ, GuideGentsHouseSign
	...
	object_event 27,  8, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, CherrygroveYoungsterScript, -1

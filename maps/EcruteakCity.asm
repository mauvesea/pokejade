...
EcruteakCity_MapEvents:
	...
	bg_event 36,  9, BGEVENT_READ, TinTowerSign
	bg_event  5, 28, BGEVENT_READ, EcruteakGymSign
	bg_event 21, 21, BGEVENT_READ, EcruteakDanceTheaterSign
	bg_event  4,  7, BGEVENT_READ, BurnedTowerSign
	...
	object_event 13, 12, SPRITE_GRAMPS, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, EcruteakCityGramps3Script, EVENT_ECRUTEAK_CITY_GRAMPS
